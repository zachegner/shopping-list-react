...
here am using the handleSearchItem as props and we are going to use this
...
function Search({ handleSearch }) {
    return (
        <div className="search">
            ...
            <input type="text" placeholder="Search for your items..." onChange={(event) => handleSearch(event.target.value)} />
        </div>
    )
}
